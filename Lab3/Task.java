...
"moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their " +
...
" welcomed and every pain avoided. But in certain circumstances and owing to the claims of duty or the obligations of business it will frequently occur that" +
 ...
 " pleasures to secure other greater pleasures, or else he endures pains to avoid worse pains.";
        ...
        System.out.println("Nr of sentences: " + textManipulation.numberOfSentences);
        System.out.println("Nr of words: "  + textManipulation.numberOfWords);
        System.out.println("Nr of letters: " + textManipulation.numberOfLetters);
        System.out.println("Nr of vowels: " + textManipulation.numberOfVowels);
        System.out.println("Nr of consonants: " + textManipulation.numberOfConsonants);
        System.out.println("The longest word: " + textManipulation.longestWord);
